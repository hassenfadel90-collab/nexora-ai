(()=>{
  ...
  const normalizeRoutes=(root=document)=>{
    ...
    root.querySelectorAll?.('img[src="assets/dashboard-showcase.jpg"],img[src$="/assets/dashboard-showcase.jpg"]').forEach(img=>{img.src=`${base}/assets/nexora-platform.svg`;img.alt='NEXORA operations dashboard preview';});
    polishShowcase();
  };
